...
class AnimatedStatus {
	...
	getDescription() {
		return "Zde máte plugin AnimatedStatus. Můžete si zde upravovat svůj discord status. By KENNY";
	}
	...
	getSettingsPanel() {
		...
		// Animace
		settings.appendChild(GUI.newLabel('Animace'));
